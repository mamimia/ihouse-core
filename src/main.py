...
# ---------------------------------------------------------------------------
# Phase 866 — Preview Mode (Server-Enforced Read-Only)
# ---------------------------------------------------------------------------

from middleware.preview_mode import PreviewModeMiddleware  # noqa: E402
...
from api.act_as_router import router as act_as_router  # noqa: E402  # Phase 868
app.include_router(act_as_router)
...
from api.self_checkin_router import router as self_checkin_router  # noqa: E402  # Phase 1005
app.include_router(self_checkin_router)
