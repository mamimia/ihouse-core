...
.nav a,.nav button,.nav div{min-height:auto!important;min-width:auto!important}
.nl{display:inline-flex;align-items:center;gap:10px}.nl svg{width:24px;height:24px}.nl span{font-family:var(--fe);font-size:18px;letter-spacing:.4px;line-height:1}
