...
/* NAV */
.nav{position:fixed;top:0;left:0;right:0;z-index:1000;padding:16px 32px;display:flex;align-items:center;justify-content:space-between;background:var(--nav-bg);backdrop-filter:blur(24px);-webkit-backdrop-filter:blur(24px);border-bottom:1px solid var(--nav-b);opacity:0;transform:translateY(-8px);transition:opacity .5s ease,transform .5s ease,background .35s,border-color .35s}.nav.v{opacity:1;transform:translateY(0)}
.nl{display:flex;align-items:center;gap:10px}.nl svg{width:24px;height:24px}.nl span{font-family:var(--fe);font-size:18px;letter-spacing:.4px;line-height:1}
.nm{display:flex;gap:24px;align-items:center}.nm a{font-family:var(--fb);font-size:12px;font-weight:500;letter-spacing:.3px;opacity:.45;transition:opacity .2s;line-height:1}.nm a:hover{opacity:1}
...
.nc{font-family:var(--fb);font-size:11px;font-weight:600;padding:8px 18px;border-radius:var(--r);background:var(--dm);color:var(--cw);letter-spacing:.3px;transition:all .28s ease-out;display:inline-flex;align-items:center;line-height:1}.nc:hover{background:#3d4d42;transform:translateY(-1px)}
