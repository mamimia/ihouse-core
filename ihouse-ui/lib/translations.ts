...
const en = {
  ...
  'auth.host_link':        'Domaniqo for Host users?',
  'auth.host_link_cta':    'Log in here',
  'auth.register_link':    'New to Domaniqo?',
  'auth.register_link_cta':'Register a new account',
...
const th: TranslationPack = {
  ...
  'auth.host_link':        'ผู้ใช้ Domaniqo สำหรับเจ้าของที่พัก?',
  'auth.host_link_cta':    'เข้าสู่ระบบที่นี่',
...
const he: TranslationPack = {
  ...
  'auth.continue':         'המשך',
  'auth.host_link':        'משתמש Domaniqo למארח?',
  'auth.host_link_cta':    'היכנס כאן',
  'auth.register_link':    'חדש ב-Domaniqo?',
  'auth.register_link_cta':'הרשם עכשיו',
