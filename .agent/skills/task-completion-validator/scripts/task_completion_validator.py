...
def main() -> int:
    ...
    if state in {"Completed", "Cancelled"}:
        ...
        out_terminal = {"actions": [], "events_to_emit": [audit], "side_effects": []}
        sys.stdout.write(json.dumps(out_terminal))
        return 0
    ...
    out_ok = {"actions": actions, "events_to_emit": [audit], "side_effects": []}
